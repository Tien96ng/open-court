...
{
    public partial class MVPInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, "225 gold st, Brooklyn, NY, 11201", true, false, "Golconda Playground", 10, 0, 0 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2021, 5, 19, 23, 45, 12, 482, DateTimeKind.Local).AddTicks(3290), "Best place to hoop in Tacoma!" });
