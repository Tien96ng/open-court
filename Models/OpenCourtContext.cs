    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Court>()
        .HasData(
            ...
            new Court { CourtId = 7,  Name = "Golconda Playground", Address = "225 gold st, Brooklyn, NY, 11201", NumberOfHoops = 10, TotalRatingCount = 0, TotalRating = 0, IsIndoor = false, IsCovidOpen = true },
